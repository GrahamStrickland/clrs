...
\begin{proof}
  ...
  \begin{equation*}
    \begin{split}
      \lg{(n!)} &\geq \lg{n^{n + 1/2}} +
      \lg{\biggl(\frac{\sqrt{2\pi}}{e^n}\biggr)} \\
  ...
  \begin{equation*}
    \begin{split}
      ...
      \Rightarrow n - \frac{\lg{n}}{2\lg{e}} &\geq
      \frac{\lg{\sqrt{2\pi}}}{\lg{e}} \\
  ...
  Now,
  \[
    n! = n \cdot (n-1) \cdots 3 \cdot 2 \cdot 1 < n \cdot n \cdots n
    \quad (n \text{ factors}),
  \]
  ...
  Then,
  \[
    n! = n \cdot (n-1) \cdots 3 \cdot 2 \cdot 1 > 2 \cdot 2 \cdots 2
    \quad (n \text{ factors}),
  \]
