...
int main() {
  ...
  for (std::chrono::duration<long long> time : runtimes) {
    double smallest_n = std::floor(
        std::pow(std::chrono::duration<double>(time).count() * 1E6, 2.0));
    std::cout << "\t" << std::setw(12) << smallest_n;
  }
  std::cout << "\n";
  ...
  for (std::chrono::duration<long long> time : runtimes) {
    double smallest_n =
        std::floor(std::chrono::duration<double>(time).count() * 1E6);
    std::cout << "\t" << std::setw(12) << smallest_n;
  }
  std::cout << "\n";
  ...
  std::cout << "nlg(n)";
  for (std::chrono::duration<long long> time : runtimes) {
    double smallest_n = std::floor(clrs::algorithms::big_oh::inverse_nlogn(
  ...
  for (std::chrono::duration<long long> time : runtimes) {
    double smallest_n = std::floor(
        ((std::log(std::chrono::duration<double>(time).count() * 1E6) /
          std::log(2.0))));
    std::cout << "\t" << std::setw(12) << smallest_n;
  }
  std::cout << "\n";
  ...
  std::cout << "n!";
  for (std::chrono::duration<long long> time : runtimes) {
    double smallest_n = clrs::algorithms::big_oh::inverse_factorial(
        std::chrono::duration<double>(time).count() * 1E6);
    std::cout << "\t" << std::setw(12) << smallest_n;
  }
