...
std::array<std::array<int32_t, 8>, 5> input_arrs = {
    {{{5, 2, 7, 4, 6, 1, 3, 8}},
...
std::array<std::array<int32_t, 8>, 5> expected_arrs = {
    {{{1, 2, 3, 4, 5, 6, 7, 8}},
